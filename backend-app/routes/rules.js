...
const Rule = require('../module/Rule.js');
const combineRule = require('../data_structure/combine-rule.js');
const createAST = require('../data_structure/createAST.js');
const evaluateRule = require('../data_structure/evaluate-rule');
